<?php
$sunrises = array(
	"dm_sunrise" => defined("DM_CUSTOM_SUNRISE") ? DM_CUSTOM_SUNRISE : ( defined( "WP_PLUGIN_DIR" ) ?  rtrim( WP_PLUGIN_DIR, '/\\' ) . "/brainys-domain-mapping/inc/sunrise.php" : dirname( __FILE__ ) .  "/plugins/brainys-domain-mapping/inc/sunrise.php" ),
